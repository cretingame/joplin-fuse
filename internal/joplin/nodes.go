...
func (fn NoteFileNode) Base() NodeBase {
	return NodeBase{
		Id:        fn.Id,
		Parent_id: fn.Parent_id,
		Name:      fn.Name,
...
func (fn *NoteFileNode) AddChild(n *Node) {
	fn.Children = append(fn.Children, n)
}

var _ = (fs.NodeOpener)((*NoteFileNode)(nil))
var _ = (fs.NodeReader)((*NoteFileNode)(nil))
var _ = (fs.NodeWriter)((*NoteFileNode)(nil))
var _ = (fs.NodeGetattrer)((*NoteFileNode)(nil))
...
func (fn *NoteFileNode) Open(ctx context.Context, flags uint32) (fh fs.FileHandle, fuseFlags uint32, errno syscall.Errno) {
...
func (fn *NoteFileNode) Read(ctx context.Context, fh fs.FileHandle, dest []byte, off int64) (fuse.ReadResult, syscall.Errno) {
	// TODO: Check integrity
	return fn.MemRegularFile.Read(ctx, fh, dest, off)
}

func (fn *NoteFileNode) Write(ctx context.Context, fh fs.FileHandle, data []byte, off int64) (uint32, syscall.Errno) {
...
func (rn ResourceFileNode) Base() NodeBase {
	return NodeBase{
		Id:        rn.Id,
...
func (rn *ResourceFileNode) AddChild(n *Node) {
	rn.Children = append(rn.Children, n)
}

var _ = (fs.NodeOpener)((*ResourceFileNode)(nil))
var _ = (fs.NodeReader)((*ResourceFileNode)(nil))

func (rn *ResourceFileNode) Open(ctx context.Context, flags uint32) (fh fs.FileHandle, fuseFlags uint32, errno syscall.Errno) {
...
func (rn *ResourceFileNode) Read(ctx context.Context, fh fs.FileHandle, dest []byte, off int64) (fuse.ReadResult, syscall.Errno) {
